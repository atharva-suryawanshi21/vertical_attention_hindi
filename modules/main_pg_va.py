...
from trainer_pg_va import Manager
from models_pg_va import VerticalAttention, LineDecoderCTC
from models import FCN_Encoder
from generic_dataset_manager import OCRDataset
import torch
...
if __name__ == "__main__":
    ...
    dataset_name = "hindi"  # ["RIMES", "IAM", "READ_2016"]

    params = {
        "dataset_params": {
            "datasets": {
                # dataset_name: "C:\Users\Atharva\Desktop\IIT_Roorkee\hindi_verti_attn_3_small_lines\Datasets\formatted,
                dataset_name: r"C:\Users\Atharva\Desktop\IIT_Roorkee\hindi_verti_attn_3_small_lines\Datasets\formatted\{}_paragraph".format(dataset_name),
            },
            "train": {
            ...
            "config": {
                ...
                "padding_value": 1,  # Image padding value
        ...
        "model_params": {
            ...
            "att_dropout": 0.2,  # dropout for attention module #################################################3
            ####################changed 0->0.2 ################################
        ...
        "training_params": {
            "output_folder": "hindi_paragraph_learned_stop",  # folder names for logs and weigths
            "max_nb_epochs": 3000,  # max number of epochs for the training
            "max_training_time": 36000000 * (24 + 23),  # max training time limit (in seconds)
            "load_epoch": "best",  # ["best", "last"], to load weights from best epoch or last trained epoch
            "interval_save_weights": 100,  # None: keep best and last only
            ...
            "optimizer": {
                ...
                "args": {
                    "lr": 0.0001,
                    "amsgrad": True, ####################next time turn it to false->true
                }
            },
